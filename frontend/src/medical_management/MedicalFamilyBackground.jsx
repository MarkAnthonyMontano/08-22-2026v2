            ...
            <Container>
                ...
                <form>
                    ...
                    <Container maxWidth="100%" sx={{ backgroundColor: "#f1f1f1", border: `1px solid ${borderColor}`, padding: 4, borderRadius: 2, boxShadow: 3 }}>
                        ...
                        {person.has_no_siblings !== 1 && normalizeSiblings(person.siblings).map((sibling, index) => (
                        ...
                        {person.has_no_siblings !== 1 && normalizeSiblings(person.siblings).length === 0 && (
